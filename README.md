...
| Script                       | Description                                             |
| ---------------------------- | ------------------------------------------------------- |
| `hello_script.sh`            | Basic shell scripting example                           |
| `hello_variable.sh`          | Demonstrates the use of shell variables                 |
| `hello_multi_variables.sh`   | Works with multiple shell variables                     |
| `printf_numbers.sh`          | Demonstrates formatted output using `printf`            |
| `create_new_script.sh`       | Script for creating new shell scripts                   |
| `function_test.sh`           | Practice working with Bash functions                    |
| `return_sum.sh`              | Demonstrates returning and using values from a function |
...
| Script            | Description                                    |
| ----------------- | ---------------------------------------------- |
| `arraysub.sh`     | Practice with Bash arrays and array operations |
...
| `verify_pages.sh` | Verifies web pages or URLs                       |
| `url_result.txt`  | Output/data generated from URL-related scripts   |

### Networking and System Administration

| Script                | Description                                               |
| --------------------- | --------------------------------------------------------- |
| `find_hosts.sh`       | Searches for or identifies hosts on a network             |
| `parallel_nc_scan.sh` | Uses `nc` to perform parallel network scanning            |
| `analyze_sshd_log.sh` | Analyzes SSH daemon log information                       |
| `sshd_logfile.log`    | Log data used for SSH/log-analysis exercises              |
| `killsleep.sh`        | Demonstrates process management and terminating processes |
| `timesleep.sh`        | Works with process timing and `sleep`                     |
| `nested_subshells.sh` | Demonstrates nested subshell behavior                     |
...
Throughout these exercises, I worked with a variety of Unix/Linux command-line tools and shell features, including:
...
Working through these scripts provided practical experience with:

1. **Automating repetitive tasks** using Bash scripts.
2. **Manipulating files and directories** from the command line.
3. **Processing structured and unstructured text** with tools such as `awk`, `sed`, and regular expressions.
4. **Working with command-line arguments** to make scripts more flexible and reusable.
